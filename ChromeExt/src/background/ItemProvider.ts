...
export interface IItemProvider
{
    ...
    rezItem(itemId: string, roomJid: string, rezzedX: number, destinationUrl: string): Promise<void>;
    derezItem(itemId: string, roomJid: string, inventoryX: number, inventoryY: number): Promise<void>;
