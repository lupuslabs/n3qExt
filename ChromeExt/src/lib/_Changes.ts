...
export class _Changes
{
    static data: IHistory = [
        ['1.5.2', 'Shop', [
            ...
            ['Add', 'Undock page/room chat window into own browser window'],
            ['Add', 'Iframe API: Window.SetTitle method'],
            ['Add', 'Iframe API: Backpack item property retrieval from room item frames'],
            ['Add', 'Iframe API: Filtered push subscription for backpack and room item changes'],
            ['Add', 'Iframe API: userAvatarPosX in room info response'],
            ...
            ['Fix', 'Tutorial videos not showing'],
            ['Fix', 'Iframe API: Window.SetTitle title forgotten on item change'],
            ['Fix', 'Initial item placement triggering before backpack window finishes opening'],
            ['Fix', 'Window geometry persistence on Firefox'],
            ['Fix', 'Icon URL used directly for backpack filter icons'],
            ['Fix', 'Private chat opening different chatrooms when own nickname changes during XMPP reconnect'],
            ['Fix', 'Whole-page blur on sites styling all ::backdrop pseudo-elements'],
            ['Fix', 'Avatar menu not closing on pointer down inside item frames'],
            ['Fix', 'Avatar menu button showing as open after menu closed by outside pointer down'],
