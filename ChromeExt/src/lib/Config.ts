        ...
        i18n: {
            ...
            translations: {
                'en-US': {
                    ...
                    'Menu.CancelFriendshipProposal': 'Cancel friendship proposal',
                    'Menu.AcceptFriendshipProposal': 'Accept friendship proposal',
                    'Menu.DeclineFriendshipProposal': 'Decline friendship proposal',
                    'Menu.CancelFriendship': 'End friendship',
                    ...
                    'PrivateChat.newMessageToastMarkAsReadButtonLabel': 'Mark as read',
                    ...
                    'PrivateVidconf.inviteToastMessage': '{otherUserName} invites you to a private videoconference.\nInvitation from: {messageTime}',
                    'PrivateVidconf.declineToastTitle': 'Private videoconference',
                    'PrivateVidconf.declineToastMessage': '{otherUserName} refuses to join the videoconference.',
                    ...
                    'Backpack.UnattachBadge': 'Remove from avatar',
                    ...
                    'Person.forgetPersonToastTitle': 'Delete Contact',
                    'Person.forgetPersonToastText': 'Really delete contact {otherUserName}?',
                    'Person.forgetPersonToastConfirmButtonLabel': 'Yes, delete contact',
                    'Person.forgetPersonToastCancelButtonLabel': 'No, do nothing',
                    'Person.friendshipProposalFromOtherToastTitle': 'Friendship Proposal',
                    'Person.friendshipProposalFromOtherToastText': '{otherUserName} would like to be your friend.',
                    'Person.friendshipProposalFromOtherToastAcceptButtonLabel': 'Accept',
                    'Person.friendshipProposalFromOtherToastDeclineButtonLabel': 'Decline',
                    'Person.proposeFriendshipToastTitle': 'Add Friend',
                    'Person.proposeFriendshipToastText': 'Add {otherUserName} as friend?',
                    'Person.proposeFriendshipToastConfirmButtonLabel': 'Yes, add as friend',
                    'Person.proposeFriendshipToastCancelButtonLabel': 'No, do nothing',
                    'Person.cancelFriendshipToastTitle': 'End Friendship',
                    ...
                    'Star.8-3': 'Three quarters white crown',
                    'Star.8-2': 'Half white crown',
                    'Star.8-1': 'Quarter white crown',
                    'Star.7-3': 'Three quarters black crown',
                    'Star.7-2': 'Half black crown',
                    'Star.7-1': 'Quarter black crown',
                    'Star.6-3': 'Three quarters blue diamond',
                    'Star.6-2': 'Half blue diamond',
                    'Star.6-1': 'Quarter blue diamond',
                    'Star.5-3': 'Three quarter gold star',
                    'Star.5-2': 'Half gold star',
                    'Star.5-1': 'Quarter gold star',
                    'Star.4-3': 'Three quarters silver star',
                    'Star.4-2': 'Half silver star',
                    'Star.4-1': 'Quarter silver star',
                    'Star.2-3': 'Three quarters gold dot',
                    'Star.3-2': 'Half copper star',
                    'Star.3-1': 'Quarter copper star',
                    'Star.3-3': 'Three quarters copper star',
                    'Star.2-2': 'Half gold dot',
                    'Star.2-1': 'Quarter gold dot',
                    'Star.1-3': 'Three quarters silver dot',
                    'Star.1-2': 'Half silver dot',
                    'Star.1-1': 'Quarter silver dot',
                    'Star.0-3': 'Three quarters copper dot',
                    'Star.0-2': 'Half copper dot',
                ...
                'de-DE': {
                    ...
                    'Menu.CancelFriendshipProposal': 'Freundschaftsanfrage zurückziehen',
                    'Menu.AcceptFriendshipProposal': 'Freundschaftsanfrage annehmen',
                    'Menu.DeclineFriendshipProposal': 'Freundschaftsanfrage ablehnen',
                    'Menu.CancelFriendship': 'Freundschaft beenden',
                    ...
                    'PrivateChat.newMessageToastMarkAsReadButtonLabel': 'Als gelesen markieren',
                    ...
                    'PrivateVidconf.inviteToastMessage': '{otherUserName} lädt dich zu einer privaten Videokonferenz ein.\nEinladung von: {messageTime}',
                    'PrivateVidconf.declineToastTitle': 'Private Videokonferenz',
                    'PrivateVidconf.declineToastMessage': '{otherUserName} lehnt die Videokonferenz ab.',
                    ...
                    'Backpack.UnattachBadge': 'Vom Avatar entfernen',
                    ...
                    'Person.forgetPersonToastTitle': 'Kontakt löschen',
                    'Person.forgetPersonToastText': 'Kontakt {otherUserName} wirklich löschen?',
                    'Person.forgetPersonToastConfirmButtonLabel': 'Ja, Kontakt löschen',
                    'Person.forgetPersonToastCancelButtonLabel': 'Nein, nichts machen',
                    'Person.friendshipProposalFromOtherToastTitle': 'Freundschaftsanfrage',
                    'Person.friendshipProposalFromOtherToastText': '{otherUserName} möchte dein Freund sein.',
                    'Person.friendshipProposalFromOtherToastAcceptButtonLabel': 'Annehmen',
                    'Person.friendshipProposalFromOtherToastDeclineButtonLabel': 'Ablehnen',
                    'Person.proposeFriendshipToastTitle': 'Freundschaft anfragen',
                    'Person.proposeFriendshipToastText': '{otherUserName} die Freundschaft anfragen?',
                    'Person.proposeFriendshipToastConfirmButtonLabel': 'Ja, Freundschaft anfragen',
                    'Person.proposeFriendshipToastCancelButtonLabel': 'Nein, nichts machen',
                    'Person.cancelFriendshipToastTitle': 'Freundschaft beenden',
                    ...
                    'Star.9': 'Weiße Krone',
                    'Star.8': 'Schwarze Krone',
                    'Star.7': 'Blauer Diamant',
                    'Star.6': 'Goldstern',
                    'Star.5': 'Silberstern',
                    'Star.4': 'Kupferstern',
                    'Star.3': 'Goldpunkt',
                    ...
                    'Star.8-3': 'Dreiviertel weiße Krone',
                    'Star.8-2': 'Halbe weiße Krone',
                    'Star.8-1': 'Viertel weiße Krone',
                    'Star.7-3': 'Dreiviertel schwarze Krone',
                    'Star.7-2': 'Halbe schwarze Krone',
                    'Star.7-1': 'Viertel schwarze Krone',
                    'Star.6-3': 'Dreiviertel blauer Diamant',
                    'Star.6-2': 'Halber blauer Diamant',
                    'Star.6-1': 'Viertel blauer Diamant',
                    'Star.5-3': 'Dreiviertel Goldstern',
                    'Star.5-2': 'Halber Goldstern',
                    'Star.5-1': 'Viertel Goldstern',
                    'Star.4-3': 'Dreiviertel Silberstern',
                    'Star.4-2': 'Halber Silberstern',
                    'Star.4-1': 'Viertel Silberstern',
                    'Star.3-3': 'Dreiviertel Kupferstern',
                    'Star.3-2': 'Halber Kupferstern',
                    'Star.3-1': 'Viertel Kupferstern',
                    'Star.2-3': 'Dreiviertel Goldpunkt',
                    'Star.2-2': 'Halber Goldpunkt',
                    'Star.2-1': 'Viertel Goldpunkt',
                    'Star.1-3': 'Dreiviertel Silberpunkt',
                    'Star.1-2': 'Halber Silberpunkt',
                    'Star.1-1': 'Viertel Silberpunkt',
                    'Star.0-3': 'Dreiviertel Kupferpunkt',
                    'Star.0-2': 'Halber Kupferpunkt',
