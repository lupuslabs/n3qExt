        ...
        i18n: {
            ...
            translations: {
                'en-US': {
                    ...
                    'iframeApi.avatarCreateTitle': 'Create avatar',
                    'iframeApi.avatarActivateTitle': 'Activate avatar',
                    'iframeApi.avatarCreateActivateTitle': 'Create and activate avatar',
                    'iframeApi.avatarCreateText': 'Create avatar {item}?',
                    'iframeApi.avatarActivateText': 'Activate avatar {item}?',
                    'iframeApi.avatarCreateActivateText': 'Create and activate avatar {item}?',
                    'iframeApi.avatarCreateBtn': 'Create',
                    'iframeApi.avatarActivateBtn': 'Activate',
                    'iframeApi.avatarCreateActivateBtn': 'Create and activate',
