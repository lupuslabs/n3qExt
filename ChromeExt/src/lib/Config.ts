        ...
        i18n: {
            ...
            translations: {
                'en-US': {
                    ...
                    'Menu.ProposeFriendship': 'Propose friendship...',
                    ...
                    'Person.forgetPersonToastTitle': 'Forget Person',
                    'Person.forgetPersonToastText': 'Really forget {otherUserName}?',
                    'Person.forgetPersonToastConfirmButtonLabel': 'Yes, forget person',
                    ...
                    'Person.proposeFriendshipToastTitle': 'Propose Friendship',
                    'Person.proposeFriendshipToastText': 'Propose friendship to {otherUserName}?',
                    'Person.proposeFriendshipToastConfirmButtonLabel': 'Propose friendship',
                    'Person.proposeFriendshipToastCancelButtonLabel': 'No, do nothing',
                    'Person.cancelFriendshipToastTitle': 'Cancel Friendship',
                    'Person.cancelFriendshipToastText': 'Cancel friendship with {otherUserName}?',
                    'Person.cancelFriendshipToastConfirmButtonLabel': 'Cancel friendship',
                ...
                'de-DE': {
                    ...
                    'Menu.CancelFriendship': 'Freundschaft kündigen...',
                    ...
                    'Person.forgetPersonToastTitle': 'Person vergessen',
                    'Person.forgetPersonToastText': '{otherUserName} wirklich vergessen?',
                    'Person.forgetPersonToastConfirmButtonLabel': 'Ja, Person vergessen',
                    ...
                    'Person.proposeFriendshipToastText': '{otherUserName} die Freundschaft vorschlagen?',
                    'Person.proposeFriendshipToastConfirmButtonLabel': 'Freundschaft anfragen',
                    'Person.proposeFriendshipToastCancelButtonLabel': 'Nein, nichts machen',
                    'Person.cancelFriendshipToastTitle': 'Freundschaft kündigen',
                    'Person.cancelFriendshipToastText': '{otherUserName} die Freundschaft kündigen?',
                    'Person.cancelFriendshipToastConfirmButtonLabel': 'Freundschaft kündigen',
